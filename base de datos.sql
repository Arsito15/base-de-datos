...
CREATE TABLE `empleados` (
  ...
  KEY `puestos_idx` (`id_puesto`),
  CONSTRAINT `puestos` FOREIGN KEY (`id_puesto`) REFERENCES `puestos` (`id_puesto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `puestos` VALUES (1,'lic'),(2,'admin');
...
-- Dump completed on 2022-08-17 21:02:31
